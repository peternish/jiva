...
const jadwalTenagaMedis = {
  ...
  getAvailableJadwalTenagaMedisList: ({ idCabang }) => {
    return axios.get(`${BASE_URL}/jadwal/tenaga-medis/available/${idCabang}/`);
  },
  ...
  createJadwalTenagaMedis: ({
    ...
    return axios.post(
      `${BASE_URL}/jadwal/tenaga-medis/create/${idTenagaMedis}/`,
      data
    );
  },
